...
addEventListener('DOMContentLoaded',()=>{
    ...
    btnCancelar.addEventListener('click',()=>{
        window.location = '/sistema_2/bole'
    })
    ...
    btnCrear.addEventListener('click',()=>{
        ...
        let nroDocBol = document.getElementById('nroDocBol')

        url = '/sistema_2/editar_boleta/' + idenProforma.value
        console.log(url)
        ejemplo = {
            'nroDocumento':nroDocBol.value,
