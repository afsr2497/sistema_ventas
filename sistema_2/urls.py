...
urlpatterns = [
    ...
    path('actualizar_abono',views.actualizar_abono,name='actualizar_abono'),
    ...
    path('eliminar_orden/<str:ind>',views.eliminar_orden,name='eliminar_orden'),
    ...
    path('modificar_orden/<str:ind>',views.modificar_orden,name='modificar_orden'),
    ...
    path('nuevaDivision',views.nuevaDivision,name='nuevaDivision'),
